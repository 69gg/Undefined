...
_BASELINE: frozenset[str] = frozenset(
    {
        ...
        "tools/bilibili_opus/handler.py::Undefined.attachments",
        "tools/bilibili_opus/handler.py::Undefined.bilibili.opus_parser",
        "tools/bilibili_opus/handler.py::Undefined.bilibili.opus_render",
        "tools/bilibili_opus/handler.py::Undefined.bilibili.opus_sender",
        "tools/bilibili_opus/handler.py::Undefined.bilibili.parser",
