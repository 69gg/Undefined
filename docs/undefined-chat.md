...
Undefined Chat 在 v3.5.2 版本完成全面重写，采用莫兰迪青蓝色系（Morandi Teal-Blue）设计系统，与 WebUI 保持视觉一致性。重写包括：

- **统一配色**：从暖橙色系重新设计为莫兰迪青蓝色系，支持浅色/深色模式，与 WebUI 视觉语言统一
...
Undefined Chat 采用与 WebUI 相同的莫兰迪青蓝色系，确保跨平台视觉体验一致：
