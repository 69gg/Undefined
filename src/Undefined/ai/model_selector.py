...
class ModelSelector:
    ...
    def _entry_to_chat_config(
        ...
        return ChatModelConfig(
            ...
            thinking_param_enabled=entry.thinking_param_enabled,
            ...
            reasoning_content_replay=entry.reasoning_content_replay,
            system_prompt_as_user=entry.system_prompt_as_user,
            responses_tool_choice_compat=entry.responses_tool_choice_compat,
            responses_force_stateless_replay=entry.responses_force_stateless_replay,
