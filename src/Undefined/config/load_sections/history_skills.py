...
def load_history_skills(
    ...
    skills_hot_reload_interval = _normalize_poll_interval(skills_hot_reload_interval)
    ...
    skills_hot_reload_debounce = _normalize_poll_interval(skills_hot_reload_debounce)
